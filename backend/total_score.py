...
def total_score(city):
    ...
    norm = norm_popularity_score #implemented
    demo = demographic_info_score(user_age, user_gender, city) #returns a list of all POIs_demogr_score
